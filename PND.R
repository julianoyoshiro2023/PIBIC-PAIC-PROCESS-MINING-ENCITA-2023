GD_alpha = read.csv('PND_alpha.csv')
GD_inductive = read.csv('PND_inductive.csv')
GD_heuristics = read.csv('PND_heuristics.csv')
N=10^5
alfa = 0.01 ## Valor de alfa para teste de hipóteses de erro do tipo I
...
write.csv(df, "C:\\Users\\julia\\CLEMATIS\\PND_Teste_Hipoteses.csv", row.names=FALSE)