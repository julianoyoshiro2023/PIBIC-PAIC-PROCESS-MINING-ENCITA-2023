GD_alpha = read.csv('GND_alpha.csv')
GD_inductive = read.csv('GND_inductive.csv')
GD_heuristics = read.csv('GND_heuristics.csv')
N=10^5
...
write.csv(df, "C:\\Users\\julia\\CLEMATIS\\GND_Teste_Hipoteses.csv", row.names=FALSE)